...
PROJECT = 'Rand report 1D RL'  # For wandb
CONTINUAL_LEARNING = False

ENV_NAME = 'myenv-v0'
ALGORITHM = 'dqn'  # 'ppo2' or 'a2c'
NUM_ENVS = 1  # Use multiple environments
...
def define_model(env, log_dir):
    if DEFAULT:
        ...
        policy_kwargs = dict(dueling=True, act_fun=ACT_FUN, net_arch=NET_ARCH)

    kwargs = {'double_q': True, 'prioritized_replay': True, 'policy_kwargs': policy_kwargs}
